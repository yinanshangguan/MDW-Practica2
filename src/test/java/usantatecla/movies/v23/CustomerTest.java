...
public class CustomerTest {
	...
	public void testBillingFunctionality() {
		...
		usantatecla.movies.v23.Movie regularMovie = new MovieBuilder().title(movieName).regular().build();

		String newReleaseMovieName = "newReleaseMovieName";
		usantatecla.movies.v23.Movie newReleaseMovie = new MovieBuilder().title(newReleaseMovieName).newRelease().build();

		String childrensMovieName = "childrensMovieName";
		usantatecla.movies.v23.Movie childrensMovie = new MovieBuilder().title(childrensMovieName).childrens().build();
	...
	public void testStatementFormat() {
		...
		usantatecla.movies.v23.Movie regularMovie = new MovieBuilder().title("regularMovie").regular().build();
		Movie newReleaseMovie = new MovieBuilder().title("newReleaseMovie").newRelease().build();
		usantatecla.movies.v23.Rental regularRental = new RentalBuilder().movie(regularMovie).daysRented(2).build();
